...
class SaisonView extends View{
    ...
    ?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
            <ul class="nav nav-pills justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/Beddek_Lilya_Sil2/SaisonController">Saison<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    public function contenu(){
        ?>
                 <h2 class="h1-responsive font-weight-bold text-center my-4">Recette de Saison</h2>
                <p class="text-center w-responsive mx-auto mb-5">Catalogue des recettes de la saison en cours!</p>

                <div class="row mt-5">
                    <?php 
                        $ctrl= new SaisonController();
                        $recettes = $ctrl->getRecettesSaison();
