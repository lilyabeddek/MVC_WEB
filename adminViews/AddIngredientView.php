...
class AddIngredientView {
    ...
    public function corp_page(){
        ...
        <form action="/Beddek_Lilya_Sil2/IngredientsController/add" name="form" id="form" method="post">    
            <legend><center><h2><b>Ajouter un Un ingredient</b></h2></center></legend><br>

            <div class="form-group row">
                <label for="title" class="col-sm-2 col-form-label">Nom</label>
                <div class="col-sm-10">
                <input type="text" class="form-control" id="titre" name="titre" placeholder="Non de l'ingredient" required>
                </div>
            </div>
            ...
            <div class="form-group row">
                <label for="proportion"  id="textInput" class="col-sm-2 col-form-label">Proportion (0%)</label>
                <div class="col-sm-10">
                    <input type="range" class="form-control" id="proportion" name="proportion" min="0" max="100" value="0" oninput="updateTextInput(this.value);">
